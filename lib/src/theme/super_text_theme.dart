...
class SuperTextPreviewTheme {
  /// Get TextPreviewTheme from BuildContext using ThemeExtension
  static SuperTextPreviewTheme? of(BuildContext context) =>
      Theme.of(context).extension<SuperTextPreviewTheme>();

  /// Get TextPreviewTheme or create a default one based on brightness
  static SuperTextPreviewTheme get(BuildContext context) {
    final theme = Theme.of(context);
    final existingTheme = theme.extension<SuperTextPreviewTheme>();

    return existingTheme ??
        (theme.brightness == Brightness.light
            ? SuperTextPreviewTheme.light(theme.textTheme)
            : SuperTextPreviewTheme.dark(theme.textTheme));
  }
  ...
  SuperTextPreviewTheme.light([TextTheme? textTheme])
      : this(
  ...
  SuperTextPreviewTheme.dark([TextTheme? textTheme])
      : this(
  ...
  SuperTextPreviewTheme copyWith({
    double? borderRadius,
  ...
  static SuperTextPreviewTheme lerp(
    SuperTextPreviewTheme? a,
    SuperTextPreviewTheme? b,
    double t,
  ) {
    if (a == null && b == null) return const SuperTextPreviewTheme();
    if (a == null) return b!;
    if (b == null) return a;
  ...
  SuperTextPreviewTheme merge(SuperTextPreviewTheme? other) {
  ...
  bool operator ==(Object other) {
    ...
    return other is SuperTextPreviewTheme &&
